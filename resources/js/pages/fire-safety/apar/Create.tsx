            ...
            <div className="space-y-6">
                ...
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <h1 className="text-xl font-bold text-foreground">Tambah APAR Baru</h1>
                        <p className="text-sm text-muted-foreground/50">Isi formulir di bawah untuk menambah data APAR baru</p>
                    </div>
                </div>
