...
export default function RoleEdit({ role, permissions, guards, flash }: Props) {
                    ...
                    <div className="relative flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                        <div className="flex items-center gap-3">
                            ...
                            <div className="min-w-0">
                                <h1 className="text-xl font-bold tracking-tight text-foreground">Edit Role: {role.name}</h1>
                                <p className="text-xs text-muted-foreground/70">Perbarui nama role dan hak aksesnya</p>
                            </div>
                        </div>
                ...
                <Card className="border-border/40 animate-in fade-in slide-in-from-y-3 duration-400 delay-100">
                    <CardHeader className="pb-3">
                        ...
                        <CardDescription className="text-muted-foreground/70">
                            Perbarui nama role, guard, dan hak aksesnya.
                        </CardDescription>
                    </CardHeader>
